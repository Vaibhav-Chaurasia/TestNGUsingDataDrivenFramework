...
@Listeners(TestNG0013ListenerClasses.ListenerIConfigurationListener2.class)

//In case, any one wants to run it from xml file then, use - IConfigurationListener.xml

public class IConfigurationListenerExecution {
